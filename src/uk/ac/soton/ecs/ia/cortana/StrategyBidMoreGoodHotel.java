...
public class StrategyBidMoreGoodHotel extends Strategy {

	public StrategyBidMoreGoodHotel(AuctionMaster auctionMaster) {
		super(auctionMaster);
	}
	
	public StrategyBidMoreGoodHotel(Strategy oldStrategy) {
		super(oldStrategy);
	}
